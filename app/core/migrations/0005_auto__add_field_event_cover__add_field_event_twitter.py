...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.cover'
        db.add_column('core_event', 'cover',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Event.twitter'
        db.add_column('core_event', 'twitter',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.cover'
        db.delete_column('core_event', 'cover')

        # Deleting field 'Event.twitter'
        db.delete_column('core_event', 'twitter')
