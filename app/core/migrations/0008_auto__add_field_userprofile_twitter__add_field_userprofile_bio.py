...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_userprofile', 'twitter',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)

        # Adding field 'UserProfile.bio'
        db.add_column('core_userprofile', 'bio',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('core_userprofile', 'twitter')

        # Deleting field 'UserProfile.bio'
        db.delete_column('core_userprofile', 'bio')
