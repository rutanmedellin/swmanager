...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.twitter'
        db.add_column('core_project', 'twitter',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.twitter'
        db.delete_column('core_project', 'twitter')
    ...
    models = {
        ...
        'core.project': {
            ...
            'team': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'projects'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"}),
            'twitter': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128'})
        },
        'core.session': {
