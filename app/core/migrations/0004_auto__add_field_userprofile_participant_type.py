...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.participant_type'
        db.add_column('core_userprofile', 'participant_type',
                      self.gf('django.db.models.fields.CharField')(default='developer', max_length=254),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.participant_type'
        db.delete_column('core_userprofile', 'participant_type')
