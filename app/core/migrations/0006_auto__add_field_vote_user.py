...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_vote', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='votes', to=orm['auth.User']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('core_vote', 'user_id')
